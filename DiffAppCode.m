classdef DiffAppCode < matlab.apps.AppBase
    ...
    methods (Access = private)
        ...
        function FilterDWIBetaButtonPushed(app, event)
            for idx = 1:1:app.Z
                app.vol(:,:,idx) = imnlmfilt(app.vol(:,:,idx));
            end
        end
    ...
    methods (Access = private)
        ...
        function createComponents(app)
            ...
            app.ROIStyleDropDown.Items = {'Rectangle', 'Polygon', 'Freehand'};
            app.ROIStyleDropDown.ItemsData = [1 2 3];
            app.ROIStyleDropDown.Position = [425 83 84 20];
            app.ROIStyleDropDown.Value = 1;
            ...
            app.LoadDICOMButton.Position = [1435 99 85 23];
            ...
            app.FilterDWIBetaButton.Position = [1428 135 104 23];
